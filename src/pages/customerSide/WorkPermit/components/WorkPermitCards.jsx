...
import WorkPermitSingleCard from "./WorkPermitSingleCard";

const WorkPermitCards = () => {
                ...
                <div className="">
                    <div className='container mx-auto'>
                        ...
                        <div className="flex flex-wrap justify-around gap-4">
                            {
                                cardsData?.map((item, idx) => <WorkPermitSingleCard key={idx} data={item}></WorkPermitSingleCard>)
                            }
                        </div>
                    </div>
                </div>
...
export default WorkPermitCards
