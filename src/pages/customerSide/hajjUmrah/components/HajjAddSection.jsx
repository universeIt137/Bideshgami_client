...
import AddCard from '../../servicePage/AddCard';
...
const HajjAddSection = () => {
    return (
        <>

            <div className='border container mx-auto mb-10 '>
                <div className=" border-b-2 lg:w-11/12 mx-auto">
                ...
                <p className='text-primary text-[12px] text-end px-10'>See all ads from this member</p>
            </div>
