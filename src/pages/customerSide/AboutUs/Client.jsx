...
const Client = () => {
    return (
        <>
            <div className='pt-60 w-2/4 mx-auto'>
                <p className='text-5xl text-center font-bold text-[#0066ff]'>OUR STAFF</p>
                ...
                <div className="bg-[#80b3ff] p-5">
                    <div className="flex  justify-around p-10 mx-auto">
                        <div className=" text-white text-center">
                            ...
                            <p className='text-2xl font-bold'>MD.SADIQUL ISLAM</p>
                        ...
                        <div className=" text-white text-center">
                            ...
                            <p className='text-2xl font-bold'>MD.MAHAMUDUL HASAN
                                FAHAD</p>
