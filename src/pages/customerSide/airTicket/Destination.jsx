        ...
        <div className="grid grid-cols-2 gap-2 pt-5 ">
            ...
            <div className="flex w-full">
                <div
                    ...
                    className={`border p-3 rounded-lg text-gray-500 w-1/2 relative ${isOpen1 ? 'bg-gray-200' : 'bg-white'} cursor-pointer`} // Change background when open
                ...
                >
                    ...
                    {isOpen1 && ( // Only show dropdown content when isOpen1 is true
                        <div className=" bg-white z-30 absolute w-full left-0">
                            <AllAirportDropDown selectedAirport={selectedAirport1} setSelectedAirport={setSelectedAirport1} openNext={true} handleOpenNext={setIsOpen2} />
                        </div>
                    )}
                </div>

                <div className="flex items-center justify-center">
                    <p onClick={handleToggleDesignation} className="text-primary p-3 bg-white border rounded-[24px] -mx-10 shadow-2xl z-20 cursor-pointer">
                ...
                <div
                    ...
                    className={`border p-3 rounded-lg text-gray-500 w-1/2 relative  ${isOpen2 ? 'bg-gray-200' : 'bg-white'} cursor-pointer`} // Change background when open
                ...
                >
                    ...
                    {isOpen2 && ( // Only show dropdown content when isOpen2 is true
                        <div className=" bg-white z-30 absolute w-full left-0">
                            <AllAirportDropDown selectedAirport={selectedAirport2} setSelectedAirport={setSelectedAirport2} />
                        </div>
                    )}
                </div>
            </div>
